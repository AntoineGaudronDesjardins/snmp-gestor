...
# ASN.1 source file://C:\Users\antoi\OneDrive - CentraleSupelec\ETSI\gestion_de_redes\proyecto\pythonScripts\mibs\mibs\IF-MIB.mib
# Produced by pysmi-0.3.4 at Mon Apr 24 01:08:54 2023
...
Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, mib_2, Unsigned32, ObjectIdentity, TimeTicks, MibIdentifier, iso, Counter32, Gauge32, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "mib-2", "Unsigned32", "ObjectIdentity", "TimeTicks", "MibIdentifier", "iso", "Counter32", "Gauge32", "ModuleIdentity", "Bits")
PhysAddress, TruthValue, TextualConvention, DisplayString, RowStatus, TestAndIncr, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TruthValue", "TextualConvention", "DisplayString", "RowStatus", "TestAndIncr", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifSpeed=ifSpeed, ifStackStatus=ifStackStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackLastChange=ifStackLastChange, ifOutDiscards=ifOutDiscards, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifAdminStatus=ifAdminStatus, ifRcvAddressEntry=ifRcvAddressEntry, ifTableLastChange=ifTableLastChange, ifIndex=ifIndex, ifPacketGroup=ifPacketGroup, ifLastChange=ifLastChange, ifStackHigherLayer=ifStackHigherLayer, ifStackGroup=ifStackGroup, ifOutOctets=ifOutOctets, ifInBroadcastPkts=ifInBroadcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifNumber=ifNumber, ifTestGroup=ifTestGroup, ifTestTable=ifTestTable, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifSpecific=ifSpecific, InterfaceIndex=InterfaceIndex, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressType=ifRcvAddressType, ifCompliance3=ifCompliance3, ifTestId=ifTestId, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliance2=ifCompliance2, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifGeneralGroup=ifGeneralGroup, ifCompliances=ifCompliances, ifXTable=ifXTable, ifFixedLengthGroup=ifFixedLengthGroup, ifCompliance=ifCompliance, ifType=ifType, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestStatus=ifTestStatus, ifOperStatus=ifOperStatus, ifStackTable=ifStackTable, ifHCOutOctets=ifHCOutOctets, ifAlias=ifAlias, ifOutQLen=ifOutQLen, ifConnectorPresent=ifConnectorPresent, ifTestCode=ifTestCode, ifDescr=ifDescr, ifName=ifName, ifHCPacketGroup=ifHCPacketGroup, linkUp=linkUp, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestResult=ifTestResult, ifHCInOctets=ifHCInOctets, ifMIBObjects=ifMIBObjects, ifTestType=ifTestType, ifInOctets=ifInOctets, ifGroups=ifGroups, ifTestOwner=ifTestOwner, ifHCInUcastPkts=ifHCInUcastPkts, ifStackGroup2=ifStackGroup2, ifMIB=ifMIB, ifOutErrors=ifOutErrors, linkDown=linkDown, ifTestEntry=ifTestEntry, ifOutMulticastPkts=ifOutMulticastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifInUcastPkts=ifInUcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackEntry=ifStackEntry, ifOutNUcastPkts=ifOutNUcastPkts, ifInUnknownProtos=ifInUnknownProtos, interfaces=interfaces, ifOutUcastPkts=ifOutUcastPkts, ifPhysAddress=ifPhysAddress, ifPromiscuousMode=ifPromiscuousMode, ifTable=ifTable, ifInErrors=ifInErrors, ifMtu=ifMtu, ifHCInMulticastPkts=ifHCInMulticastPkts, ifVHCPacketGroup=ifVHCPacketGroup, OwnerString=OwnerString, ifConformance=ifConformance, ifRcvAddressAddress=ifRcvAddressAddress, ifEntry=ifEntry, ifHighSpeed=ifHighSpeed, ifHCOutUcastPkts=ifHCOutUcastPkts, ifXEntry=ifXEntry, ifInDiscards=ifInDiscards, ifStackLowerLayer=ifStackLowerLayer, PYSNMP_MODULE_ID=ifMIB, ifInNUcastPkts=ifInNUcastPkts)
