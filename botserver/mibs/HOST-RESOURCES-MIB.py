...
# ASN.1 source file://C:\Users\antoi\OneDrive - CentraleSupelec\ETSI\gestion_de_redes\proyecto\pythonScripts\mibs\mibs\HOST-RESOURCES-MIB.mib
...
TextualConvention, AutonomousType, DateAndTime, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "DateAndTime", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrSWOSIndex=hrSWOSIndex, hrDiskStorageAccess=hrDiskStorageAccess, hrSWRunIndex=hrSWRunIndex, hrDiskStorageMedia=hrDiskStorageMedia, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSystemGroup=hrSystemGroup, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrStorage=hrStorage, hrPartitionTable=hrPartitionTable, hrNetworkEntry=hrNetworkEntry, hrStorageUsed=hrStorageUsed, hrFSType=hrFSType, hrMIBCompliances=hrMIBCompliances, hrProcessorEntry=hrProcessorEntry, hrProcessorLoad=hrProcessorLoad, hrStorageSize=hrStorageSize, hrNetworkTable=hrNetworkTable, hrProcessorFrwID=hrProcessorFrwID, hrSWRunEntry=hrSWRunEntry, hrDeviceType=hrDeviceType, host=host, hrDeviceTypes=hrDeviceTypes, hrSWRunPerfEntry=hrSWRunPerfEntry, hrFSAccess=hrFSAccess, hrSWInstalledLastChange=hrSWInstalledLastChange, hrSWInstalledDate=hrSWInstalledDate, hrMemorySize=hrMemorySize, hrDevice=hrDevice, hrSystemDate=hrSystemDate, hrSWRunGroup=hrSWRunGroup, hrSWRunPerfCPU=hrSWRunPerfCPU, hrFSTable=hrFSTable, hrDiskStorageEntry=hrDiskStorageEntry, hrSWRunPath=hrSWRunPath, hrPartitionIndex=hrPartitionIndex, hrSWRunTable=hrSWRunTable, hrStorageAllocationUnits=hrStorageAllocationUnits, hrSystemProcesses=hrSystemProcesses, hrSystemUptime=hrSystemUptime, hrPartitionFSIndex=hrPartitionFSIndex, hrSystemMaxProcesses=hrSystemMaxProcesses, hrStorageGroup=hrStorageGroup, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSWInstalledIndex=hrSWInstalledIndex, hrDeviceStatus=hrDeviceStatus, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrDeviceEntry=hrDeviceEntry, hrSWRunID=hrSWRunID, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrDeviceDescr=hrDeviceDescr, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrFSTypes=hrFSTypes, hrPartitionSize=hrPartitionSize, hrPartitionLabel=hrPartitionLabel, hrPartitionID=hrPartitionID, hrFSBootable=hrFSBootable, hrSWRunStatus=hrSWRunStatus, hrSWInstalledID=hrSWInstalledID, hrStorageEntry=hrStorageEntry, hrSWRunPerf=hrSWRunPerf, hrFSStorageIndex=hrFSStorageIndex, hrNetworkIfIndex=hrNetworkIfIndex, hrMIBGroups=hrMIBGroups, hrPrinterStatus=hrPrinterStatus, hrSWInstalledType=hrSWInstalledType, hrSWInstalledGroup=hrSWInstalledGroup, InternationalDisplayString=InternationalDisplayString, hrSWRun=hrSWRun, hrStorageTable=hrStorageTable, PYSNMP_MODULE_ID=hostResourcesMibModule, hrStorageTypes=hrStorageTypes, hrPartitionEntry=hrPartitionEntry, hrMIBAdminInfo=hrMIBAdminInfo, hrFSEntry=hrFSEntry, hrDeviceID=hrDeviceID, hrSWRunParameters=hrSWRunParameters, hrStorageAllocationFailures=hrStorageAllocationFailures, ProductID=ProductID, hrSWRunPerfMem=hrSWRunPerfMem, KBytes=KBytes, hrStorageDescr=hrStorageDescr, hrSystem=hrSystem, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrSWInstalledTable=hrSWInstalledTable, hrSWInstalledEntry=hrSWInstalledEntry, hostResourcesMibModule=hostResourcesMibModule, hrDeviceErrors=hrDeviceErrors, hrPrinterEntry=hrPrinterEntry, hrProcessorTable=hrProcessorTable, hrSystemNumUsers=hrSystemNumUsers, hrSWRunType=hrSWRunType, hrStorageIndex=hrStorageIndex, hrDeviceTable=hrDeviceTable, hrMIBCompliance=hrMIBCompliance, hrDiskStorageTable=hrDiskStorageTable, hrStorageType=hrStorageType, hrSWInstalledName=hrSWInstalledName, hrFSIndex=hrFSIndex, hrSWRunPerfTable=hrSWRunPerfTable, hrFSMountPoint=hrFSMountPoint, hrSWRunPerfGroup=hrSWRunPerfGroup, hrSWInstalled=hrSWInstalled, hrPrinterTable=hrPrinterTable, hrDeviceIndex=hrDeviceIndex, hrSWRunName=hrSWRunName, hrDeviceGroup=hrDeviceGroup)
