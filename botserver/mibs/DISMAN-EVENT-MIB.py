...
# ASN.1 source file://C:\Users\antoi\OneDrive - CentraleSupelec\ETSI\gestion_de_redes\proyecto\pythonScripts\mibs\mibs\DISMAN-EVENT-MIB.mib
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: dismanEventMIB.setRevisionsDescriptions(('This is the initial version of this MIB. Published as RFC 2981',))
...
if mibBuilder.loadTexts: mteTriggerEnabled.setDescription("A control to allow a trigger to be configured but not used. When the value is 'false' the trigger is not sampled.")
...
if mibBuilder.loadTexts: mteTriggerEntryStatus.setDescription('The control that allows creation and deletion of entries. Once made active an entry may not be modified except to delete it.')
...
if mibBuilder.loadTexts: mteEventEntryStatus.setDescription('The control that allows creation and deletion of entries. Once made active an entry MAY not be modified except to delete it.')
...
if mibBuilder.loadTexts: mteEventNotification.setDescription("The object identifier from the NOTIFICATION-TYPE for the notification to use if metEventActions has 'notification' set.")
...
mibBuilder.exportSymbols("DISMAN-EVENT-MIB", dismanEventMIB=dismanEventMIB, mteTriggerBooleanEvent=mteTriggerBooleanEvent, mteTriggerFailure=mteTriggerFailure, mteTriggerEntry=mteTriggerEntry, mteTriggerDeltaEntry=mteTriggerDeltaEntry, mteTriggerBooleanStartup=mteTriggerBooleanStartup, mteTriggerComment=mteTriggerComment, mteTriggerThresholdRisingEventOwner=mteTriggerThresholdRisingEventOwner, dismanEventMIBConformance=dismanEventMIBConformance, mteObjectsName=mteObjectsName, FailureReason=FailureReason, mteResourceSampleInstanceMaximum=mteResourceSampleInstanceMaximum, mteTriggerObjectsOwner=mteTriggerObjectsOwner, mteTriggerThresholdRising=mteTriggerThresholdRising, dismanEventMIBNotificationObjects=dismanEventMIBNotificationObjects, mteTriggerExistenceEventOwner=mteTriggerExistenceEventOwner, dismanEventMIBNotificationPrefix=dismanEventMIBNotificationPrefix, mteTriggerExistenceTable=mteTriggerExistenceTable, mteResource=mteResource, mteTriggerFrequency=mteTriggerFrequency, mteTriggerThresholdObjectsOwner=mteTriggerThresholdObjectsOwner, mteTriggerThresholdObjects=mteTriggerThresholdObjects, mteEventTable=mteEventTable, mteEventEntryStatus=mteEventEntryStatus, mteEventSetContextNameWildcard=mteEventSetContextNameWildcard, mteTriggerFalling=mteTriggerFalling, mteTrigger=mteTrigger, mteTriggerObjects=mteTriggerObjects, mteTriggerThresholdFallingEvent=mteTriggerThresholdFallingEvent, mteTriggerFired=mteTriggerFired, mteTriggerDeltaTable=mteTriggerDeltaTable, mteObjectsIndex=mteObjectsIndex, dismanEventEventGroup=dismanEventEventGroup, mteTriggerBooleanEventOwner=mteTriggerBooleanEventOwner, mteTriggerThresholdDeltaFalling=mteTriggerThresholdDeltaFalling, mteTriggerBooleanValue=mteTriggerBooleanValue, mteEventSetEntry=mteEventSetEntry, mteEventSetObjectWildcard=mteEventSetObjectWildcard, mteTriggerThresholdRisingEvent=mteTriggerThresholdRisingEvent, dismanEventMIBCompliance=dismanEventMIBCompliance, dismanEventMIBObjects=dismanEventMIBObjects, sysUpTimeInstance=sysUpTimeInstance, mteObjectsEntryStatus=mteObjectsEntryStatus, mteTriggerBooleanTable=mteTriggerBooleanTable, mteTriggerBooleanComparison=mteTriggerBooleanComparison, mteEventComment=mteEventComment, mteTriggerThresholdTable=mteTriggerThresholdTable, mteEventActions=mteEventActions, mteEventNotificationTable=mteEventNotificationTable, mteTriggerDeltaDiscontinuityIDWildcard=mteTriggerDeltaDiscontinuityIDWildcard, mteTriggerExistenceObjectsOwner=mteTriggerExistenceObjectsOwner, mteOwner=mteOwner, mteTriggerValueIDWildcard=mteTriggerValueIDWildcard, mteObjectsIDWildcard=mteObjectsIDWildcard, mteTriggerExistenceEvent=mteTriggerExistenceEvent, mteTriggerThresholdDeltaRisingEventOwner=mteTriggerThresholdDeltaRisingEventOwner, mteEventSetObject=mteEventSetObject, mteEvent=mteEvent, mteTriggerThresholdDeltaFallingEvent=mteTriggerThresholdDeltaFallingEvent, mteEventName=mteEventName, mteTriggerExistenceTest=mteTriggerExistenceTest, dismanEventResourceGroup=dismanEventResourceGroup, mteTriggerTargetTag=mteTriggerTargetTag, dismanEventMIBGroups=dismanEventMIBGroups, dismanEventNotificationGroup=dismanEventNotificationGroup, mteTriggerThresholdEntry=mteTriggerThresholdEntry, dismanEventObjectsGroup=dismanEventObjectsGroup, dismanEventNotificationObjectGroup=dismanEventNotificationObjectGroup, mteEventNotificationObjectsOwner=mteEventNotificationObjectsOwner, mteTriggerBooleanObjects=mteTriggerBooleanObjects, mteHotValue=mteHotValue, mteEventNotificationObjects=mteEventNotificationObjects, mteObjectsEntry=mteObjectsEntry, mteTriggerThresholdStartup=mteTriggerThresholdStartup, mteTriggerContextName=mteTriggerContextName, mteTriggerTest=mteTriggerTest, dismanEventTriggerGroup=dismanEventTriggerGroup, mteTriggerExistenceEntry=mteTriggerExistenceEntry, mteTriggerDeltaDiscontinuityIDType=mteTriggerDeltaDiscontinuityIDType, dismanEventMIBNotifications=dismanEventMIBNotifications, mteHotTargetName=mteHotTargetName, mteTriggerTable=mteTriggerTable, mteEventNotificationEntry=mteEventNotificationEntry, mteTriggerBooleanEntry=mteTriggerBooleanEntry, mteObjectsID=mteObjectsID, mteEventSetValue=mteEventSetValue, PYSNMP_MODULE_ID=dismanEventMIB, mteTriggerExistenceObjects=mteTriggerExistenceObjects, mteTriggerName=mteTriggerName, mteEventEntry=mteEventEntry, mteEventEnabled=mteEventEnabled, mteTriggerThresholdDeltaRising=mteTriggerThresholdDeltaRising, mteTriggerThresholdDeltaFallingEventOwner=mteTriggerThresholdDeltaFallingEventOwner, mteTriggerThresholdDeltaRisingEvent=mteTriggerThresholdDeltaRisingEvent, mteObjects=mteObjects, mteResourceSampleInstanceLacks=mteResourceSampleInstanceLacks, mteHotTrigger=mteHotTrigger, mteTriggerExistenceStartup=mteTriggerExistenceStartup, mteTriggerFailures=mteTriggerFailures, mteTriggerRising=mteTriggerRising, mteEventSetContextName=mteEventSetContextName, mteEventSetFailure=mteEventSetFailure, mteObjectsTable=mteObjectsTable, mteHotOID=mteHotOID, mteEventSetTable=mteEventSetTable, mteTriggerContextNameWildcard=mteTriggerContextNameWildcard, mteResourceSampleInstances=mteResourceSampleInstances, mteEventNotification=mteEventNotification, mteTriggerEnabled=mteTriggerEnabled, mteTriggerThresholdFallingEventOwner=mteTriggerThresholdFallingEventOwner, mteTriggerBooleanObjectsOwner=mteTriggerBooleanObjectsOwner, mteEventSetTargetTag=mteEventSetTargetTag, mteHotContextName=mteHotContextName, dismanEventMIBCompliances=dismanEventMIBCompliances, mteTriggerValueID=mteTriggerValueID, mteTriggerDeltaDiscontinuityID=mteTriggerDeltaDiscontinuityID, mteResourceSampleMinimum=mteResourceSampleMinimum, mteTriggerThresholdFalling=mteTriggerThresholdFalling, mteResourceSampleInstancesHigh=mteResourceSampleInstancesHigh, mteTriggerEntryStatus=mteTriggerEntryStatus, mteTriggerSampleType=mteTriggerSampleType, mteFailedReason=mteFailedReason, mteEventFailures=mteEventFailures)
