...
# ASN.1 source file://C:\Users\antoi\OneDrive - CentraleSupelec\ETSI\gestion_de_redes\proyecto\pythonScripts\mibs\mibs\IP-FORWARD-MIB.mib
...
InetAddress, InetAddressType, InetAddressPrefixLength, InetAutonomousSystemNumber = mibBuilder.importSymbols("INET-ADDRESS-MIB", "InetAddress", "InetAddressType", "InetAddressPrefixLength", "InetAutonomousSystemNumber")
...
if mibBuilder.loadTexts: inetCidrRoutePfxLen.setDescription('Indicates the number of leading one bits that form the mask to be logical-ANDed with the destination address before being compared to the value in the inetCidrRouteDest field. The values for the index objects inetCidrRouteDest and inetCidrRoutePfxLen must be consistent. When the value of inetCidrRouteDest (excluding the zone index, if one is present) is x, then the bitwise logical-AND of x with the value of the mask formed from the corresponding index object inetCidrRoutePfxLen MUST be equal to x. If not, then the index pair is not consistent and an inconsistentName error must be returned on SET or CREATE requests.')
...
if mibBuilder.loadTexts: ipForwardOldCompliance.setDescription('The compliance statement for SNMP entities that implement the ipForward MIB.')
...
mibBuilder.exportSymbols("IP-FORWARD-MIB", inetCidrRouteMetric4=inetCidrRouteMetric4, ipForwardProto=ipForwardProto, ipCidrRouteNextHop=ipCidrRouteNextHop, inetCidrRouteIfIndex=inetCidrRouteIfIndex, inetCidrRouteMetric2=inetCidrRouteMetric2, inetCidrRouteDestType=inetCidrRouteDestType, ipCidrRouteInfo=ipCidrRouteInfo, ipForwardFullCompliance=ipForwardFullCompliance, ipCidrRouteTos=ipCidrRouteTos, ipCidrRouteIfIndex=ipCidrRouteIfIndex, ipCidrRouteMetric1=ipCidrRouteMetric1, ipForwardCompliance=ipForwardCompliance, ipForwardGroups=ipForwardGroups, ipCidrRouteAge=ipCidrRouteAge, ipForwardNumber=ipForwardNumber, ipForwardMetric3=ipForwardMetric3, ipForwardMetric4=ipForwardMetric4, inetCidrRoutePfxLen=inetCidrRoutePfxLen, inetCidrRouteMetric5=inetCidrRouteMetric5, ipCidrRouteStatus=ipCidrRouteStatus, ipForwardMetric2=ipForwardMetric2, ipForwardInfo=ipForwardInfo, inetCidrRouteNumber=inetCidrRouteNumber, ipCidrRouteMetric5=ipCidrRouteMetric5, inetCidrRouteMetric3=inetCidrRouteMetric3, ipCidrRouteProto=ipCidrRouteProto, inetCidrRouteNextHopType=inetCidrRouteNextHopType, inetCidrRouteTable=inetCidrRouteTable, ipForwardCompliances=ipForwardCompliances, ipCidrRouteMetric3=ipCidrRouteMetric3, inetCidrRoutePolicy=inetCidrRoutePolicy, inetForwardCidrRouteGroup=inetForwardCidrRouteGroup, ipCidrRouteType=ipCidrRouteType, ipForwardType=ipForwardType, inetCidrRouteNextHopAS=inetCidrRouteNextHopAS, ipForwardDest=ipForwardDest, ipForwardCidrRouteGroup=ipForwardCidrRouteGroup, ipCidrRouteNextHopAS=ipCidrRouteNextHopAS, ipCidrRouteMetric2=ipCidrRouteMetric2, ipCidrRouteMask=ipCidrRouteMask, ipForwardMetric5=ipForwardMetric5, ipForwardNextHop=ipForwardNextHop, ipForwardIfIndex=ipForwardIfIndex, ipCidrRouteNumber=ipCidrRouteNumber, ipCidrRouteDest=ipCidrRouteDest, inetCidrRouteDiscards=inetCidrRouteDiscards, ipCidrRouteMetric4=ipCidrRouteMetric4, ipCidrRouteTable=ipCidrRouteTable, ipCidrRouteEntry=ipCidrRouteEntry, ipForwardPolicy=ipForwardPolicy, inetCidrRouteType=inetCidrRouteType, inetCidrRouteMetric1=inetCidrRouteMetric1, ipForwardNextHopAS=ipForwardNextHopAS, ipForwardConformance=ipForwardConformance, ipForwardTable=ipForwardTable, inetCidrRouteProto=inetCidrRouteProto, ipForwardReadOnlyCompliance=ipForwardReadOnlyCompliance, inetCidrRouteNextHop=inetCidrRouteNextHop, ipForwardAge=ipForwardAge, inetCidrRouteDest=inetCidrRouteDest, ipForwardMask=ipForwardMask, ipForwardOldCompliance=ipForwardOldCompliance, ipForwardMultiPathGroup=ipForwardMultiPathGroup, inetCidrRouteStatus=inetCidrRouteStatus, ipForwardEntry=ipForwardEntry, inetCidrRouteAge=inetCidrRouteAge, ipForwardMetric1=ipForwardMetric1, ipForward=ipForward, inetCidrRouteEntry=inetCidrRouteEntry, PYSNMP_MODULE_ID=ipForward)
