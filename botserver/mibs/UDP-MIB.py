...
# ASN.1 source file://C:\Users\antoi\OneDrive - CentraleSupelec\ETSI\gestion_de_redes\proyecto\pythonScripts\mibs\mibs\UDP-MIB.mib
...
iso, TimeTicks, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, Counter64, Integer32, Gauge32, Counter32, Unsigned32, MibIdentifier, mib_2, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "Counter64", "Integer32", "Gauge32", "Counter32", "Unsigned32", "MibIdentifier", "mib-2", "Bits")
...
mibBuilder.exportSymbols("UDP-MIB", udpEndpointRemotePort=udpEndpointRemotePort, udpEndpointRemoteAddress=udpEndpointRemoteAddress, udpInDatagrams=udpInDatagrams, udpNoPorts=udpNoPorts, udpHCInDatagrams=udpHCInDatagrams, udpMIBCompliance2=udpMIBCompliance2, udpTable=udpTable, udpEndpointLocalAddressType=udpEndpointLocalAddressType, udpGroup=udpGroup, udpEndpointInstance=udpEndpointInstance, udpEndpointLocalPort=udpEndpointLocalPort, udpLocalAddress=udpLocalAddress, udpLocalPort=udpLocalPort, udpHCOutDatagrams=udpHCOutDatagrams, udpMIBGroups=udpMIBGroups, PYSNMP_MODULE_ID=udpMIB, udpEndpointTable=udpEndpointTable, udpEndpointProcess=udpEndpointProcess, udpMIB=udpMIB, udpEndpointGroup=udpEndpointGroup, udpEndpointRemoteAddressType=udpEndpointRemoteAddressType, udpBaseGroup=udpBaseGroup, udpMIBConformance=udpMIBConformance, udpEndpointLocalAddress=udpEndpointLocalAddress, udpInErrors=udpInErrors, udpEndpointEntry=udpEndpointEntry, udpMIBCompliances=udpMIBCompliances, udpHCGroup=udpHCGroup, udpMIBCompliance=udpMIBCompliance, udp=udp, udpEntry=udpEntry, udpOutDatagrams=udpOutDatagrams)
