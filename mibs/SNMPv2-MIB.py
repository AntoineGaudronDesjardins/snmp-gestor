...
# ASN.1 source file://C:\Users\antoi\OneDrive - CentraleSupelec\ETSI\gestion_de_redes\proyecto\pythonScripts\mibs\mibs\SNMPv2-MIB.mib
...
Counter64, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, mib_2, Unsigned32, ObjectIdentity, TimeTicks, MibIdentifier, iso, Counter32, Gauge32, ModuleIdentity, snmpModules, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "mib-2", "Unsigned32", "ObjectIdentity", "TimeTicks", "MibIdentifier", "iso", "Counter32", "Gauge32", "ModuleIdentity", "snmpModules", "Bits")
...
mibBuilder.exportSymbols("SNMPv2-MIB", snmpSilentDrops=snmpSilentDrops, sysObjectID=sysObjectID, snmpSetGroup=snmpSetGroup, snmpOutTraps=snmpOutTraps, snmpInBadValues=snmpInBadValues, snmpTraps=snmpTraps, systemGroup=systemGroup, sysORLastChange=sysORLastChange, snmp=snmp, snmpBasicComplianceRev2=snmpBasicComplianceRev2, snmpInTooBigs=snmpInTooBigs, sysName=sysName, snmpInPkts=snmpInPkts, snmpInGetNexts=snmpInGetNexts, sysOREntry=sysOREntry, snmpNotificationGroup=snmpNotificationGroup, coldStart=coldStart, snmpOutGetResponses=snmpOutGetResponses, snmpOutSetRequests=snmpOutSetRequests, snmpBasicCompliance=snmpBasicCompliance, snmpInASNParseErrs=snmpInASNParseErrs, snmpTrapEnterprise=snmpTrapEnterprise, snmpInBadVersions=snmpInBadVersions, snmpInSetRequests=snmpInSetRequests, sysORID=sysORID, system=system, snmpInBadCommunityNames=snmpInBadCommunityNames, snmpCommunityGroup1=snmpCommunityGroup1, snmpMIB=snmpMIB, snmpInTotalReqVars=snmpInTotalReqVars, sysUpTime=sysUpTime, snmpEnableAuthenTraps=snmpEnableAuthenTraps, sysORDescr=sysORDescr, snmpInGetRequests=snmpInGetRequests, snmpInGetResponses=snmpInGetResponses, snmpOutTooBigs=snmpOutTooBigs, sysContact=sysContact, PYSNMP_MODULE_ID=snmpMIB, sysLocation=sysLocation, snmpBasicNotificationsGroup=snmpBasicNotificationsGroup, snmpObsoleteGroup=snmpObsoleteGroup, snmpMIBGroups=snmpMIBGroups, snmpInReadOnlys=snmpInReadOnlys, sysDescr=sysDescr, snmpOutPkts=snmpOutPkts, sysORTable=sysORTable, snmpOutGetNexts=snmpOutGetNexts, snmpMIBCompliances=snmpMIBCompliances, snmpMIBConformance=snmpMIBConformance, sysORIndex=sysORIndex, snmpInBadCommunityUses=snmpInBadCommunityUses, snmpInTotalSetVars=snmpInTotalSetVars, snmpGroup=snmpGroup, snmpSet=snmpSet, warmStart=warmStart, snmpWarmStartNotificationGroup=snmpWarmStartNotificationGroup, sysORUpTime=sysORUpTime, snmpInTraps=snmpInTraps, snmpTrapOID=snmpTrapOID, snmpTrap=snmpTrap, snmpOutBadValues=snmpOutBadValues, snmpMIBObjects=snmpMIBObjects, snmpInNoSuchNames=snmpInNoSuchNames, snmpOutNoSuchNames=snmpOutNoSuchNames, snmpProxyDrops=snmpProxyDrops, snmpOutGetRequests=snmpOutGetRequests, authenticationFailure=authenticationFailure, snmpOutGenErrs=snmpOutGenErrs, sysServices=sysServices, snmpInGenErrs=snmpInGenErrs, snmpSetSerialNo=snmpSetSerialNo)
