...
# ASN.1 source file://C:\Users\antoi\OneDrive - CentraleSupelec\ETSI\gestion_de_redes\proyecto\snmp-gestor\mibs\mibs\MIKROTIK-MIB.mib
...
iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, TimeTicks, Integer32, enterprises, NotificationType, Bits, ModuleIdentity, Unsigned32, ObjectIdentity, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "TimeTicks", "Integer32", "enterprises", "NotificationType", "Bits", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "Gauge32", "Counter64")
...
mikrotikExperimentalModule.setRevisions(('2016-08-31 00:00',))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: mikrotikExperimentalModule.setRevisionsDescriptions(('',))
if mibBuilder.loadTexts: mikrotikExperimentalModule.setLastUpdated('201608310000Z')
...
mtxrWlCMRtabAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 14988, 1, 1, 1, 5, 1, 1), MacAddress())
...
mtxrLTEModemGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 14988, 1, 2, 1, 19)).setObjects(("MIKROTIK-MIB", "mtxrLTEModemSignalRSSI"), ("MIKROTIK-MIB", "mtxrLTEModemSignalRSRQ"), ("MIKROTIK-MIB", "mtxrLTEModemSignalRSRP"), ("MIKROTIK-MIB", "mtxrLTEModemCellId"), ("MIKROTIK-MIB", "mtxrLTEModemAccessTechnology"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
...
mibBuilder.exportSymbols("MIKROTIK-MIB", mtxrValid=mtxrValid, mtxrNeighborMacAddress=mtxrNeighborMacAddress, mtxrInterfaceStatsRx64=mtxrInterfaceStatsRx64, mtxrScriptRunCmd=mtxrScriptRunCmd, mtxrWlApEntry=mtxrWlApEntry, mtxrHlPower=mtxrHlPower, mtxrInterfaceStatsRxUnknownOp=mtxrInterfaceStatsRxUnknownOp, mtxrInterfaceStatsTx1519ToMax=mtxrInterfaceStatsTx1519ToMax, mtxrInterfaceStatsTxDeferred=mtxrInterfaceStatsTxDeferred, mtxrWlApIndex=mtxrWlApIndex, mtxrHealthGroup=mtxrHealthGroup, mtxrInterfaceStatsRx1519ToMax=mtxrInterfaceStatsRx1519ToMax, mtxrWlApBand=mtxrWlApBand, mtxrScriptTableEntry=mtxrScriptTableEntry, mtxrInterfaceStatsTxLateCollision=mtxrInterfaceStatsTxLateCollision, mtxrNeighborIpAddress=mtxrNeighborIpAddress, PYSNMP_MODULE_ID=mikrotikExperimentalModule, mtxrPartitionSize=mtxrPartitionSize, mtxrInterfaceStatsDriverTxBytes=mtxrInterfaceStatsDriverTxBytes, mtxrQueueSimplePacketsOut=mtxrQueueSimplePacketsOut, mtxrLongtitude=mtxrLongtitude, mtxrWlCMRtabTable=mtxrWlCMRtabTable, mtxrInterfaceStatsRxFragment=mtxrInterfaceStatsRxFragment, mtxrPartitionEntry=mtxrPartitionEntry, mtxrInterfaceStatsRxDrop=mtxrInterfaceStatsRxDrop, mtxrWirelessModemGroup=mtxrWirelessModemGroup, mtxrInterfaceStatsTx512To1023=mtxrInterfaceStatsTx512To1023, mtxrQueueTreeHCBytes=mtxrQueueTreeHCBytes, mtxrInterfaceStatsTable=mtxrInterfaceStatsTable, mtxrWlRtabRxBytes=mtxrWlRtabRxBytes, mtxrInterfaceStatsTx1024To1518=mtxrInterfaceStatsTx1024To1518, mtxrDnStatTable=mtxrDnStatTable, mtxrLicVersion=mtxrLicVersion, mtxrScriptRun=mtxrScriptRun, mtxrLicUpgradableTo=mtxrLicUpgradableTo, mtxrPartitionActive=mtxrPartitionActive, mtxrHealth=mtxrHealth, mtxrWlRtabRxRate=mtxrWlRtabRxRate, mtxrHotspotActiveUserConnectTime=mtxrHotspotActiveUserConnectTime, mtxrInterfaceStatsTxRx512To1023=mtxrInterfaceStatsTxRx512To1023, mtxrWlStatRxRate=mtxrWlStatRxRate, mtxrWlStatSsid=mtxrWlStatSsid, mtxrInterfaceStatsGroup=mtxrInterfaceStatsGroup, mtxrWlApNoiseFloor=mtxrWlApNoiseFloor, mtxrHotspotActiveUserGroup=mtxrHotspotActiveUserGroup, mtXRouterOs=mtXRouterOs, mtxrSystem=mtxrSystem, mtxrGPSGroup=mtxrGPSGroup, Temperature=Temperature, mtxrQueueTreeFlow=mtxrQueueTreeFlow, mtxrPartitionName=mtxrPartitionName, mtxrWlApTxRate=mtxrWlApTxRate, mtxrPOEEntry=mtxrPOEEntry, mtxrWlRtabEntry=mtxrWlRtabEntry, mtxrHotspotActiveUserPacketsOut=mtxrHotspotActiveUserPacketsOut, mtxrInterfaceStatsRxMulticast=mtxrInterfaceStatsRxMulticast, mtxrInterfaceStatsRxJabber=mtxrInterfaceStatsRxJabber, mtxrWlStatEntry=mtxrWlStatEntry, mtxrSystemGroup=mtxrSystemGroup, mtxrAltitude=mtxrAltitude, mtxrInterfaceStatsRxLengthError=mtxrInterfaceStatsRxLengthError, mtxrInterfaceStats=mtxrInterfaceStats, mtxrWlRtabTable=mtxrWlRtabTable, mtxrScriptName=mtxrScriptName, mtxrInterfaceStatsRxPackets=mtxrInterfaceStatsRxPackets, mtxrWlCMRtabRxRate=mtxrWlCMRtabRxRate, mtxrQueueSimplePacketsIn=mtxrQueueSimplePacketsIn, mtxrQueueSimpleSrcAddr=mtxrQueueSimpleSrcAddr, mtxrWlStatTable=mtxrWlStatTable, mtxrFirmwareVersion=mtxrFirmwareVersion, mtxrQueueSimpleBytesOut=mtxrQueueSimpleBytesOut, mtxrHlPowerSupplyState=mtxrHlPowerSupplyState, mtxrHlSensorTemperature=mtxrHlSensorTemperature, mtxrWlRtabTxStrengthCh2=mtxrWlRtabTxStrengthCh2, mtxrPOECurrent=mtxrPOECurrent, mtxrDnStatEntry=mtxrDnStatEntry, mtxrDHCPGroup=mtxrDHCPGroup, mtxrInterfaceStatsTxPauseHonored=mtxrInterfaceStatsTxPauseHonored, mtxrQueueSimpleIndex=mtxrQueueSimpleIndex, mtxrQueueSimpleTable=mtxrQueueSimpleTable, BoolValue=BoolValue, mtxrWlApSsid=mtxrWlApSsid, mtxrScripts=mtxrScripts, mtxrInterfaceStatsTxDrop=mtxrInterfaceStatsTxDrop, mtxrInterfaceStatsDriverRxBytes=mtxrInterfaceStatsDriverRxBytes, mtxrPartitionRunning=mtxrPartitionRunning, mtxrTrapGroup=mtxrTrapGroup, mtxrScriptRunTable=mtxrScriptRunTable, mtxrHotspotActiveUserIdleStartTime=mtxrHotspotActiveUserIdleStartTime, mtxrWirelessModemSignalStrength=mtxrWirelessModemSignalStrength, mtxrInterfaceStatsTx128To255=mtxrInterfaceStatsTx128To255, mtxrInterfaceStatsTxTooShort=mtxrInterfaceStatsTxTooShort, mtxrPartitionVersion=mtxrPartitionVersion, mtxrHotspot=mtxrHotspot, mtxrNeighborTableEntry=mtxrNeighborTableEntry, mtxrPOEVoltage=mtxrPOEVoltage, mtxrLicSoftwareId=mtxrLicSoftwareId, mtxrQueueSimpleIface=mtxrQueueSimpleIface, mtxrInterfaceStatsTxBroadcast=mtxrInterfaceStatsTxBroadcast, mtxrWlStatBssid=mtxrWlStatBssid, mtxrHotspotActiveUserName=mtxrHotspotActiveUserName, mtxrWirelessModem=mtxrWirelessModem, mtxrWlCMRtabTxBytes=mtxrWlCMRtabTxBytes, mtxrInterfaceStatsTxExcessiveCollision=mtxrInterfaceStatsTxExcessiveCollision, mtxrInterfaceStatsRx128To255=mtxrInterfaceStatsRx128To255, mtxrPartitionTable=mtxrPartitionTable, mtxrNstremeDual=mtxrNstremeDual, mtxrInterfaceStatsTxMulticast=mtxrInterfaceStatsTxMulticast, mtxrHlProcessorTemperature=mtxrHlProcessorTemperature, mtxrWlRtabTxRate=mtxrWlRtabTxRate, mtxrWlRtabTxPackets=mtxrWlRtabTxPackets, mtxrWlCMRtabIface=mtxrWlCMRtabIface, mtxrFirmwareUpgradeVersion=mtxrFirmwareUpgradeVersion, mtxrHotspotActiveUserIP=mtxrHotspotActiveUserIP, Voltage=Voltage, mtxrPOE=mtxrPOE, mtxrInterfaceStatsDriverTxPackets=mtxrInterfaceStatsDriverTxPackets, mtxrHlCurrent=mtxrHlCurrent, mtxrNotifications=mtxrNotifications, mtxrWlRtabRxPackets=mtxrWlRtabRxPackets, mtxrInterfaceStatsTxRx128To255=mtxrInterfaceStatsTxRx128To255, mtxrInterfaceStatsRxFCSError=mtxrInterfaceStatsRxFCSError, mtxrWlRtabAddr=mtxrWlRtabAddr, mtxrWlRtabRxStrengthCh0=mtxrWlRtabRxStrengthCh0, mtxrHlCoreVoltage=mtxrHlCoreVoltage, mtxrWirelessGroup=mtxrWirelessGroup, mtxrInterfaceStatsRx512To1023=mtxrInterfaceStatsRx512To1023, mtxrInterfaceStatsRx65To127=mtxrInterfaceStatsRx65To127, mtxrWlRtabTxBytes=mtxrWlRtabTxBytes, mtxrWlApAuthClientCount=mtxrWlApAuthClientCount, mtxrWireless=mtxrWireless, mtxrPartition=mtxrPartition, mtxrWlCMRtabRxPackets=mtxrWlCMRtabRxPackets, mtxrPartitionGroup=mtxrPartitionGroup, mtxrWlApOverallTxCCQ=mtxrWlApOverallTxCCQ, mtxrWlCMRtabTxPackets=mtxrWlCMRtabTxPackets, mtxrScriptTable=mtxrScriptTable, mtxrInterfaceStatsTxPause=mtxrInterfaceStatsTxPause, mtxrLTEModemAccessTechnology=mtxrLTEModemAccessTechnology, mtxrWlRtabRxStrengthCh1=mtxrWlRtabRxStrengthCh1, mtxrQueueTreeDropped=mtxrQueueTreeDropped, mtxrSystemReboot=mtxrSystemReboot, mtxrInterfaceStatsTxExcessiveDeferred=mtxrInterfaceStatsTxExcessiveDeferred, mtxrHlTwelveVoltage=mtxrHlTwelveVoltage, mtxrNeighborIndex=mtxrNeighborIndex, mtxrDnStatTxStrength=mtxrDnStatTxStrength, mtxrInterfaceStatsRxTooShort=mtxrInterfaceStatsRxTooShort, mtxrLTEModemSignalRSRQ=mtxrLTEModemSignalRSRQ, mikrotikExperimentalModule=mikrotikExperimentalModule, mtxrBuildTime=mtxrBuildTime, mtxrWlApClientCount=mtxrWlApClientCount, mtxrInterfaceStatsRxControl=mtxrInterfaceStatsRxControl, mtxrWlCMRtabTxStrength=mtxrWlCMRtabTxStrength, mtxrInterfaceStatsTxUnderrun=mtxrInterfaceStatsTxUnderrun, mtxrNstremeDualGroup=mtxrNstremeDualGroup, mtxrLicUpgrUntil=mtxrLicUpgrUntil, mtxrHlFanSpeed1=mtxrHlFanSpeed1, mtxrQueueSimpleEntry=mtxrQueueSimpleEntry, mtxrWlRtabStrength=mtxrWlRtabStrength, mtxrQueueTreeParentIndex=mtxrQueueTreeParentIndex, mtxrScriptRunOutput=mtxrScriptRunOutput, mtxrPOETable=mtxrPOETable, mtxrWlRtabUptime=mtxrWlRtabUptime, mtxrDnStatTxRate=mtxrDnStatTxRate, mtxrNeighborIdentity=mtxrNeighborIdentity, mtxrWlStatTxRate=mtxrWlStatTxRate, mtxrQueueTreeTable=mtxrQueueTreeTable, mtxrPartitionIndex=mtxrPartitionIndex, mtxrHotspotActiveUserRadius=mtxrHotspotActiveUserRadius, mtxrInterfaceStatsTxMultipleCollision=mtxrInterfaceStatsTxMultipleCollision, mtxrScriptRunGroup=mtxrScriptRunGroup, mtxrDate=mtxrDate, mtxrWlRtabRouterOSVersion=mtxrWlRtabRouterOSVersion, mtXRouterOsGroups=mtXRouterOsGroups, mtxrWlCMRtabRxBytes=mtxrWlCMRtabRxBytes, mtxrQueueTreePackets=mtxrQueueTreePackets, mtxrHotspotActiveUserAdvertStatus=mtxrHotspotActiveUserAdvertStatus, mtxrQueueTreeEntry=mtxrQueueTreeEntry, mtxrDHCP=mtxrDHCP, mtxrWlRtabEntryCount=mtxrWlRtabEntryCount, mtxrInterfaceStatsEntry=mtxrInterfaceStatsEntry, mtxrHotspotActiveUserIdleTimeout=mtxrHotspotActiveUserIdleTimeout, mtXMetaInfo=mtXMetaInfo, mtxrLTEModem=mtxrLTEModem, mtxrQueueSimpleDstAddr=mtxrQueueSimpleDstAddr, ObjectIndex=ObjectIndex, mtxrHotspotActiveUserDomain=mtxrHotspotActiveUserDomain, mtxrInterfaceStatsTxRx256To511=mtxrInterfaceStatsTxRx256To511, mtxrInterfaceStatsTxRx1024To1518=mtxrInterfaceStatsTxRx1024To1518, mtxrDnConnected=mtxrDnConnected, mtxrSerialNumber=mtxrSerialNumber, mtxrScriptGroup=mtxrScriptGroup, mtxrWlStatStrength=mtxrWlStatStrength, mtxrInterfaceStatsRxTooLong=mtxrInterfaceStatsRxTooLong, mtxrWlCMRtabAddr=mtxrWlCMRtabAddr, mtxrHotspotActiveUserPacketsIn=mtxrHotspotActiveUserPacketsIn, mtxrQueueSimpleDstMask=mtxrQueueSimpleDstMask, mtxrLTEModemEntry=mtxrLTEModemEntry, mtxrHotspotActiveUserMAC=mtxrHotspotActiveUserMAC, mtxrWlStatFreq=mtxrWlStatFreq, mtxrLatitude=mtxrLatitude, mtxrInterfaceStatsIndex=mtxrInterfaceStatsIndex, mtxrHlActiveFan=mtxrHlActiveFan, mtxrWirelessModemSignalECIO=mtxrWirelessModemSignalECIO, mtxrQueueSimplePCQQueuesIn=mtxrQueueSimplePCQQueuesIn, mtxrLTEModemGroup=mtxrLTEModemGroup, mtxrWlCMRtabRxStrength=mtxrWlCMRtabRxStrength, mtxrHotspotActiveUserBytesOut=mtxrHotspotActiveUserBytesOut, mtxrNeighborSoftwareID=mtxrNeighborSoftwareID, mtxrQueueSimpleDroppedIn=mtxrQueueSimpleDroppedIn, mtxrNeighborVersion=mtxrNeighborVersion, mtxrPOEStatus=mtxrPOEStatus, mtxrGps=mtxrGps, mtxrUSBPowerReset=mtxrUSBPowerReset, mtxrInterfaceStatsTxBytes=mtxrInterfaceStatsTxBytes, mtxrWlCMRtabTxRate=mtxrWlCMRtabTxRate, mtxrNeighbor=mtxrNeighbor, mtxrTrap=mtxrTrap, mtxrHotspotActiveUserLimitBytesOut=mtxrHotspotActiveUserLimitBytesOut, mtxrTemperatureException=mtxrTemperatureException, mtxrWlRtabIface=mtxrWlRtabIface, mtxrLincenseGroup=mtxrLincenseGroup, mtxrLTEModemSignalRSSI=mtxrLTEModemSignalRSSI, mtxrQueueTreeBytes=mtxrQueueTreeBytes, mtxrHlBoardTemperature=mtxrHlBoardTemperature, mtxrInterfaceStatsTxSingleCollision=mtxrInterfaceStatsTxSingleCollision, mtxrInterfaceStatsDriverRxPackets=mtxrInterfaceStatsDriverRxPackets, mtxrInterfaceStatsTxTooLong=mtxrInterfaceStatsTxTooLong, mtxrLicense=mtxrLicense, mtxrHotspotActiveUserServerID=mtxrHotspotActiveUserServerID, mtxrInterfaceStatsTx256To511=mtxrInterfaceStatsTx256To511, mtxrScriptIndex=mtxrScriptIndex, mtxrPOEPower=mtxrPOEPower, mtxrInterfaceStatsTx64=mtxrInterfaceStatsTx64, mtxrLTEModemCellId=mtxrLTEModemCellId, mtxrHotspotActiveUserPingTimeout=mtxrHotspotActiveUserPingTimeout, mtxrWlApRxRate=mtxrWlApRxRate, mtxrSpeed=mtxrSpeed, mtxrDnStatRxRate=mtxrDnStatRxRate, mtxrWlRtabSignalToNoise=mtxrWlRtabSignalToNoise, mtxrNote=mtxrNote, mtxrTraps=mtxrTraps, mtxrHotspotActiveUsersTable=mtxrHotspotActiveUsersTable, mtxrLTEModemSignalRSRP=mtxrLTEModemSignalRSRP, mtxrInterfaceStatsRx256To511=mtxrInterfaceStatsRx256To511, mtxrSattelites=mtxrSattelites, mtxrNeighborTable=mtxrNeighborTable, mtxrDnStatRxStrength=mtxrDnStatRxStrength, mtxrHlVoltage=mtxrHlVoltage, mtxrPOEGroup=mtxrPOEGroup, mtxrInterfaceStatsTxPackets=mtxrInterfaceStatsTxPackets, mtxrWlRtabTxStrengthCh0=mtxrWlRtabTxStrengthCh0, mtxrWlApTable=mtxrWlApTable, mtxrQueueTreeName=mtxrQueueTreeName)
mibBuilder.exportSymbols("MIKROTIK-MIB", mtxrInterfaceStatsTxRx64=mtxrInterfaceStatsTxRx64, HexInt=HexInt, mtxrInterfaceStatsRxAlignError=mtxrInterfaceStatsRxAlignError, mtxrWlRtabTxStrengthCh1=mtxrWlRtabTxStrengthCh1, mtxrNeighborGroup=mtxrNeighborGroup, mtxrInterfaceStatsTxCollision=mtxrInterfaceStatsTxCollision, mtxrWlStatIndex=mtxrWlStatIndex, mtxrInterfaceStatsName=mtxrInterfaceStatsName, mtxrHlTemperature=mtxrHlTemperature, mtxrHlFiveVoltage=mtxrHlFiveVoltage, mtxrInterfaceStatsRxBytes=mtxrInterfaceStatsRxBytes, mtxrWlApBssid=mtxrWlApBssid, mtxrHotspotActiveUsersTableEntry=mtxrHotspotActiveUsersTableEntry, mtxrQueueSimpleSrcMask=mtxrQueueSimpleSrcMask, mtxrHotspotActiveUserIndex=mtxrHotspotActiveUserIndex, mtxrLicLevel=mtxrLicLevel, mtxrInterfaceStatsRx1024To1518=mtxrInterfaceStatsRx1024To1518, mtxrWlRtabRxStrengthCh2=mtxrWlRtabRxStrengthCh2, mtxrWlRtabTxStrength=mtxrWlRtabTxStrength, mtxrHlProcessorFrequency=mtxrHlProcessorFrequency, mtxrScriptRunTableEntry=mtxrScriptRunTableEntry, mtxrWlApFreq=mtxrWlApFreq, mtxrInterfaceStatsTxControl=mtxrInterfaceStatsTxControl, mtxrHlFanSpeed2=mtxrHlFanSpeed2, mtxrHotspotActiveUserBytesIn=mtxrHotspotActiveUserBytesIn, mtxrInterfaceStatsRxOverflow=mtxrInterfaceStatsRxOverflow, mtxrInterfaceStatsTxFCSError=mtxrInterfaceStatsTxFCSError, mtxrScriptRunIndex=mtxrScriptRunIndex, mtxrWlCMRtabEntryCount=mtxrWlCMRtabEntryCount, mtxrInterfaceStatsTx65To127=mtxrInterfaceStatsTx65To127, mtxrQueueGroup=mtxrQueueGroup, mtxrInterfaceStatsTxRx1519ToMax=mtxrInterfaceStatsTxRx1519ToMax, mtxrHlThreeDotThreeVoltage=mtxrHlThreeDotThreeVoltage, Power=Power, mtxrDnStatIndex=mtxrDnStatIndex, mtxrInterfaceStatsTxJabber=mtxrInterfaceStatsTxJabber, mtxrHlBackupPowerSupplyState=mtxrHlBackupPowerSupplyState, mtxrQueueTreePCQQueues=mtxrQueueTreePCQQueues, mtxrInterfaceStatsRxBroadcast=mtxrInterfaceStatsRxBroadcast, mtxrInterfaceStatsRxCarrierError=mtxrInterfaceStatsRxCarrierError, mtxrInterfaceStatsTxTotalCollision=mtxrInterfaceStatsTxTotalCollision, mtxrInterfaceStatsTxFragment=mtxrInterfaceStatsTxFragment, mtxrPOEInterfaceIndex=mtxrPOEInterfaceIndex, mtxrWlStatBand=mtxrWlStatBand, mtxrQueueSimpleDroppedOut=mtxrQueueSimpleDroppedOut, mtxrPOEName=mtxrPOEName, mtxrLTEModemTable=mtxrLTEModemTable, mtxrInterfaceStatsTxRx65To127=mtxrInterfaceStatsTxRx65To127, mtxrHotspotActiveUserLimitBytesIn=mtxrHotspotActiveUserLimitBytesIn, mtxrNeighborPlatform=mtxrNeighborPlatform, mtxrQueueSimplePCQQueuesOut=mtxrQueueSimplePCQQueuesOut, mtxrQueueSimpleName=mtxrQueueSimpleName, mtxrHlCpuTemperature=mtxrHlCpuTemperature, mtxrHotspotActiveUserValidTillTime=mtxrHotspotActiveUserValidTillTime, mtxrLTEModemInterfaceIndex=mtxrLTEModemInterfaceIndex, mtxrHotspotActiveUserBlockedByAdvert=mtxrHotspotActiveUserBlockedByAdvert, mtxrQueueTreeIndex=mtxrQueueTreeIndex, mtxrInterfaceStatsRxCodeError=mtxrInterfaceStatsRxCodeError, mtxrInterfaceStatsRxPause=mtxrInterfaceStatsRxPause, mtxrQueueSimpleBytesIn=mtxrQueueSimpleBytesIn, mtxrQueues=mtxrQueues, mikrotik=mikrotik, mtxrWlCMRtabEntry=mtxrWlCMRtabEntry, mtxrDHCPLeaseCount=mtxrDHCPLeaseCount, mtxrWlCMRtabUptime=mtxrWlCMRtabUptime, mtxrNeighborInterfaceID=mtxrNeighborInterfaceID)
