...
# ASN.1 source file://C:\Users\antoi\OneDrive - CentraleSupelec\ETSI\gestion_de_redes\proyecto\snmp-gestor\mibs\mibs\NET-SNMP-EXTEND-MIB.mib
# Produced by pysmi-0.3.4 at Fri May 12 23:49:11 2023
...
Integer32, MibIdentifier, Unsigned32, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Counter64, NotificationType, TimeTicks, ObjectIdentity, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "Unsigned32", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Counter64", "NotificationType", "TimeTicks", "ObjectIdentity", "iso", "Bits")
...
if mibBuilder.loadTexts: netSnmpExtendMIB.setContactInfo('postal: Wes Hardaker P.O. Box 382 Davis CA 95617 email: net-snmp-coders@lists.sourceforge.net')
...
if mibBuilder.loadTexts: nsExtendStatus.setDescription("Used to create new rows in the table, in the standard manner. Note that is valid for an instance to be left with the value notInService(2) indefinitely - i.e. the meaning of 'abnormally long' (see RFC 2579, RowStatus) for this table is infinite.")
...
if mibBuilder.loadTexts: nsExtendOutNumLines.setDescription('The number of lines of output (and hence the number of rows in nsExtendOutputTable relating to this particular entry).')
...
if mibBuilder.loadTexts: nsExtendLineIndex.setDescription('The index of this line of output. For a given nsExtendToken, this will run from 1 to the corresponding value of nsExtendNumLines.')
...
mibBuilder.exportSymbols("NET-SNMP-EXTEND-MIB", nsExtendConfigTable=nsExtendConfigTable, nsExtendOutput2Entry=nsExtendOutput2Entry, nsExtendOutputFull=nsExtendOutputFull, nsExtendInput=nsExtendInput, nsExtendStatus=nsExtendStatus, nsExtendLineIndex=nsExtendLineIndex, netSnmpExtendMIB=netSnmpExtendMIB, nsExtendStorage=nsExtendStorage, nsExtendOutput1Table=nsExtendOutput1Table, nsExtendGroups=nsExtendGroups, nsExtendOutputGroup=nsExtendOutputGroup, nsExtendNumEntries=nsExtendNumEntries, nsExtendOutNumLines=nsExtendOutNumLines, nsExtendConfigGroup=nsExtendConfigGroup, nsExtendArgs=nsExtendArgs, nsExtendToken=nsExtendToken, nsExtendCommand=nsExtendCommand, nsExtendObjects=nsExtendObjects, PYSNMP_MODULE_ID=netSnmpExtendMIB, nsExtendConfigEntry=nsExtendConfigEntry, nsExtendRunType=nsExtendRunType, nsExtendOutput1Line=nsExtendOutput1Line, nsExtendCacheTime=nsExtendCacheTime, nsExtendOutput2Table=nsExtendOutput2Table, nsExtendResult=nsExtendResult, nsExtendExecType=nsExtendExecType, nsExtendOutLine=nsExtendOutLine, nsExtendOutput1Entry=nsExtendOutput1Entry)
