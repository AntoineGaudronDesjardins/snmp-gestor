...
# ASN.1 source file://C:\Users\antoi\OneDrive - CentraleSupelec\ETSI\gestion_de_redes\proyecto\pythonScripts\mibs\mibs\TCP-MIB.mib
...
mibBuilder.exportSymbols("TCP-MIB", tcpRetransSegs=tcpRetransSegs, tcpInErrs=tcpInErrs, tcpListenerProcess=tcpListenerProcess, tcpConnectionLocalAddressType=tcpConnectionLocalAddressType, tcpBaseGroup=tcpBaseGroup, tcpOutSegs=tcpOutSegs, tcpConnectionRemAddressType=tcpConnectionRemAddressType, tcpConnectionRemPort=tcpConnectionRemPort, tcpMIBGroups=tcpMIBGroups, tcpCurrEstab=tcpCurrEstab, tcpMaxConn=tcpMaxConn, tcpActiveOpens=tcpActiveOpens, tcpConnTable=tcpConnTable, tcpMIB=tcpMIB, tcpConnState=tcpConnState, tcpHCGroup=tcpHCGroup, tcpConnectionGroup=tcpConnectionGroup, tcpPassiveOpens=tcpPassiveOpens, tcpListenerLocalAddress=tcpListenerLocalAddress, tcpConnLocalAddress=tcpConnLocalAddress, tcpListenerEntry=tcpListenerEntry, tcpRtoAlgorithm=tcpRtoAlgorithm, tcpConnectionLocalAddress=tcpConnectionLocalAddress, tcpConnectionLocalPort=tcpConnectionLocalPort, tcpInSegs=tcpInSegs, tcpRtoMax=tcpRtoMax, tcpHCInSegs=tcpHCInSegs, tcpListenerTable=tcpListenerTable, tcpConnectionRemAddress=tcpConnectionRemAddress, tcpConnEntry=tcpConnEntry, tcpListenerLocalPort=tcpListenerLocalPort, tcpMIBConformance=tcpMIBConformance, tcpConnectionEntry=tcpConnectionEntry, tcpAttemptFails=tcpAttemptFails, tcpConnectionState=tcpConnectionState, tcpConnRemPort=tcpConnRemPort, tcpGroup=tcpGroup, tcpMIBCompliances=tcpMIBCompliances, tcpConnRemAddress=tcpConnRemAddress, tcp=tcp, tcpEstabResets=tcpEstabResets, PYSNMP_MODULE_ID=tcpMIB, tcpListenerLocalAddressType=tcpListenerLocalAddressType, tcpListenerGroup=tcpListenerGroup, tcpHCOutSegs=tcpHCOutSegs, tcpOutRsts=tcpOutRsts, tcpRtoMin=tcpRtoMin, tcpMIBCompliance=tcpMIBCompliance, tcpConnectionTable=tcpConnectionTable, tcpConnLocalPort=tcpConnLocalPort, tcpMIBCompliance2=tcpMIBCompliance2, tcpConnectionProcess=tcpConnectionProcess)
